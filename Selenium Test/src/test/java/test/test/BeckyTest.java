...
public class BeckyTest {
	...
	public void login() {
		...
		driver.findElement(By.id("user-identifier-input")).sendKeys("matt.jo.hunt@gmail.com");

		// need to set temp password if using
		driver.findElement(By.id("password-input")).sendKeys("DaveSucksEggs4Eva");
